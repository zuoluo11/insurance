...
namespace Wesley.Crawler.SimpleCrawler
{
    class HistoryCode
    {
        ...
        public static void ConcurrentCrawler()
        {
            ...
            //};
            var hotelList = new List<Hotel>() {
                new Hotel { HotelName="遵义浙商酒店", Uri=new Uri("http://ygb.xiaoma66.cn/prod/getInfoList/pt/6/sid/0/page/1") },
                new Hotel { HotelName="遵义森林大酒店", Uri=new Uri("http://ygb.xiaoma66.cn/prod/getInfoList/pt/0/sid/0/page/1") },
            };
            var hotelCrawler = new SimpleCrawler();
            hotelCrawler.OnStart += (s, e) =>
            {
